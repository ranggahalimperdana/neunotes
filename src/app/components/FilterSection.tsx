...
interface FilterSectionProps {
  ...
  // Data List dari Database (Disesuaikan dengan App.tsx)
  faculties?: Faculty[];
  prodiList?: Prodi[];
  semesters?: Semester[];
}
...
export default function FilterSection({
  ...
  onSemesterChange,
  onClearFilters,
  // Berikan nilai default [] agar tidak error jika data belum siap
  faculties = [], 
  prodiList = [], 
  semesters = []
}: FilterSectionProps) {
          ...
          <div className="group">
            ...
            <div className="relative">
              ...
              >
                ...
                {/* Mapping Data Fakultas dari Database */}
                {faculties.map((f) => (
          ...
          <div className="group">
            ...
            <div className="relative">
              ...
              >
                ...
                {/* Mapping Data Prodi dari Database */}
                {prodiList.map((p) => (
          ...
          <div className="group">
            ...
            <div className="relative">
              ...
              >
                ...
                {/* Mapping Data Semester dari Database */}
                {semesters.map((s) => (
